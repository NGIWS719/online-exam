...
class Teacher(models.Model):
    ...
    dept = models.CharField('学院', max_length=20, choices=DEPT, default='理学院')
    email = models.EmailField('邮箱', default='179101536@qq.com')
    password = models.CharField('密码', max_length=20, default='000000')
    birth = models.DateField('出生日期', default='2019-01-02')
